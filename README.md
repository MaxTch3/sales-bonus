...
## Описание проекта
По собранным в датасете данным о продажах в магазине составляется рейтинг продавцов по доходности и расчитываются бонусы для каждого продавца.
...
https://github.com/MaxTch3/sales-bonus
